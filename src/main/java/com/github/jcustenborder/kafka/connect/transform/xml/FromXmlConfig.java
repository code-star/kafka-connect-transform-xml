...
class FromXmlConfig extends AbstractConfig {
  ...
  public static final String KEY_CONDITION_REGEX_CONFIG = "key.condition.regex";
  ...
  static final String KEY_CONDITION_REGEX_DOC = "The transformation will be applied only if the key matches this regex";
  ...
  public final String keyCondition;
  ...
  public FromXmlConfig(Map<?, ?> originals) {
    ...
    this.keyCondition = getString(KEY_CONDITION_REGEX_CONFIG);
  }
  ...
  public static ConfigDef config() {
    ...
    return new ConfigDef()
        .define(
            ...
            ConfigKeyBuilder.of(KEY_CONDITION_REGEX_CONFIG, ConfigDef.Type.STRING)
                .documentation(KEY_CONDITION_REGEX_DOC)
                .importance(ConfigDef.Importance.LOW)
                .defaultValue("")
                .build()
        );
